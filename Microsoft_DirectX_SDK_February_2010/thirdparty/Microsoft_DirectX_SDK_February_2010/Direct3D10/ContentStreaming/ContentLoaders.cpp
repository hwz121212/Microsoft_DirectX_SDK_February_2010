...
BOOL CTextureProcessor::PopulateTexture()
{
    ...
    DDSURFACEDESC2_32BIT* pSurfDesc9 = ( DDSURFACEDESC2_32BIT* )( ( BYTE* )m_pData + sizeof( DWORD ) );
    ...
    if( 0 == MipLevels )
        MipLevels = 1;
    D3DFORMAT Format = GetD3D9Format( pSurfDesc9->ddpfPixelFormat );
    ...
    void* pTexData = ( BYTE* )m_pData + sizeof( DWORD ) + sizeof( DDSURFACEDESC2_32BIT ) + BytesToSkip;
