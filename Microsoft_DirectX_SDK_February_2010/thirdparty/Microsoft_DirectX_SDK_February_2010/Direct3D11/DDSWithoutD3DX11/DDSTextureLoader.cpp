...
//--------------------------------------------------------------------------------------
static HRESULT LoadTextureDataFromFile( __in_z WCHAR* szFileName, BYTE** ppHeapData,
                                        DDS_HEADER** ppHeader,
...
//--------------------------------------------------------------------------------------
HRESULT CreateDDSTextureFromFile( ID3D11Device* pDev, WCHAR* szFileName, ID3D11ShaderResourceView** ppSRV, bool bSRGB )
{
    BYTE* pHeapData = NULL;
    DDS_HEADER* pHeader = NULL;
    BYTE* pBitData = NULL;
