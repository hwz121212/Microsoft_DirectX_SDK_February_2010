...
HRESULT CreateShaderFromFile( ID3D11Device* pd3dDevice, LPCWSTR pSrcFile, CONST D3D10_SHADER_MACRO* pDefines, 
                              ...
                              ID3DX11ThreadPump* pPump, ID3D11DeviceChild** ppShader, ID3D10Blob** ppShaderBlob = NULL, 
                              BOOL bDumpShader = FALSE);
HRESULT CreateVertexShaderFromFile( ID3D11Device* pd3dDevice, LPCWSTR pSrcFile, CONST D3D10_SHADER_MACRO* pDefines, 
                                    LPD3D10INCLUDE pInclude, LPCSTR pFunctionName, LPCSTR pProfile, UINT Flags1, UINT Flags2, 
                                    ID3DX11ThreadPump* pPump, ID3D11VertexShader** ppShader, ID3D10Blob** ppShaderBlob = NULL, 
                                    BOOL bDumpShader = FALSE);
HRESULT CreateHullShaderFromFile( ID3D11Device* pd3dDevice, LPCWSTR pSrcFile, CONST D3D10_SHADER_MACRO* pDefines, 
                                  LPD3D10INCLUDE pInclude, LPCSTR pFunctionName, LPCSTR pProfile, UINT Flags1, UINT Flags2, 
                                  ID3DX11ThreadPump* pPump, ID3D11HullShader** ppShader, ID3D10Blob** ppShaderBlob = NULL, 
                                  BOOL bDumpShader = FALSE);
HRESULT CreateDomainShaderFromFile( ID3D11Device* pd3dDevice, LPCWSTR pSrcFile, CONST D3D10_SHADER_MACRO* pDefines, 
                                    LPD3D10INCLUDE pInclude, LPCSTR pFunctionName, LPCSTR pProfile, UINT Flags1, UINT Flags2, 
                                    ID3DX11ThreadPump* pPump, ID3D11DomainShader** ppShader, ID3D10Blob** ppShaderBlob = NULL, 
                                    BOOL bDumpShader = FALSE);
HRESULT CreateGeometryShaderFromFile( ID3D11Device* pd3dDevice, LPCWSTR pSrcFile, CONST D3D10_SHADER_MACRO* pDefines, 
                                      LPD3D10INCLUDE pInclude, LPCSTR pFunctionName, LPCSTR pProfile, UINT Flags1, UINT Flags2, 
                                      ID3DX11ThreadPump* pPump, ID3D11GeometryShader** ppShader, ID3D10Blob** ppShaderBlob = NULL, 
                                      BOOL bDumpShader = FALSE);
HRESULT CreatePixelShaderFromFile( ID3D11Device* pd3dDevice, LPCWSTR pSrcFile, CONST D3D10_SHADER_MACRO* pDefines, 
                                   LPD3D10INCLUDE pInclude, LPCSTR pFunctionName, LPCSTR pProfile, UINT Flags1, UINT Flags2, 
                                   ID3DX11ThreadPump* pPump, ID3D11PixelShader** ppShader, ID3D10Blob** ppShaderBlob = NULL, 
                                   BOOL bDumpShader = FALSE);
HRESULT CreateComputeShaderFromFile( ID3D11Device* pd3dDevice, LPCWSTR pSrcFile, CONST D3D10_SHADER_MACRO* pDefines, 
                                     LPD3D10INCLUDE pInclude, LPCSTR pFunctionName, LPCSTR pProfile, UINT Flags1, UINT Flags2, 
                                     ID3DX11ThreadPump* pPump, ID3D11ComputeShader** ppShader, ID3D10Blob** ppShaderBlob = NULL, 
                                     BOOL bDumpShader = FALSE);
...
int WINAPI wWinMain( HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR lpCmdLine, int nCmdShow )
{
    ...
    DXUTCreateWindow( L"DetailTessellation11 v1.11" );
...
void InitApp()
{
    ...
    iX += 35;
    g_SampleUI.AddStatic( IDC_STATIC_TEXTURE, L"Te(X)ture:", iX, iY += 50, 55, 24 );
    ...
    g_SampleUI.AddCheckBox( IDC_CHECKBOX_DISTANCEADAPTIVE, L"D(I)stance-adaptive", iX, iY += 25, 140, 24, 
...
void CALLBACK OnGUIEvent( UINT nEvent, int nControlID, CDXUTControl* pControl, void* pUserContext )
{
    ...
    switch( nControlID )
    {
        ...
        case IDC_RADIOBUTTON_DISABLED:              
        {
            ...
            g_SampleUI.GetControl( IDC_CHECKBOX_DISTANCEADAPTIVE )->SetEnabled( false );
            g_SampleUI.GetControl( IDC_CHECKBOX_DISTANCEADAPTIVE )->SetHotkey( 0 );
        ...
        case IDC_RADIOBUTTON_DETAILTESSELLATION:    
        {
            ...
            g_SampleUI.GetControl( IDC_CHECKBOX_DISTANCEADAPTIVE )->SetEnabled( true );
            g_SampleUI.GetControl( IDC_CHECKBOX_DISTANCEADAPTIVE )->SetHotkey( 'I' );
        ...
        case IDC_CHECKBOX_DISTANCEADAPTIVE:
        {
                                      ...
                                      void* pUserContext )
{
    ...
    V_RETURN( pd3dDevice->CreateInputLayout( tangentspacevertexlayout, ARRAYSIZE( tangentspacevertexlayout ), 
                                             pBlobVS_DetailTessellation->GetBufferPointer(), pBlobVS_DetailTessellation->GetBufferSize(), 
                                  ...
                                  double fTime, float fElapsedTime, void* pUserContext )
{
    ...
    ((CONSTANT_BUFFER_STRUCT *)MappedSubResource.pData)->vTessellationFactor =             
        D3DXVECTOR4( g_fTessellationFactorEdges, g_fTessellationFactorInside, g_fTessellationFactorEdges / 2.0f, 0.0f );  
...
HRESULT CreateVertexShaderFromFile( ID3D11Device* pd3dDevice, LPCWSTR pSrcFile, CONST D3D10_SHADER_MACRO* pDefines, 
                                    LPD3D10INCLUDE pInclude, LPCSTR pFunctionName, LPCSTR pProfile, UINT Flags1, UINT Flags2, 
                                    ID3DX11ThreadPump* pPump, ID3D11VertexShader** ppShader, ID3D10Blob** ppShaderBlob, 
                                    BOOL bDumpShader )
{
...
HRESULT CreateHullShaderFromFile( ID3D11Device* pd3dDevice, LPCWSTR pSrcFile, CONST D3D10_SHADER_MACRO* pDefines, 
                                  LPD3D10INCLUDE pInclude, LPCSTR pFunctionName, LPCSTR pProfile, UINT Flags1, UINT Flags2, 
                                  ID3DX11ThreadPump* pPump, ID3D11HullShader** ppShader, ID3D10Blob** ppShaderBlob, 
                                  BOOL bDumpShader )
{
    return CreateShaderFromFile( pd3dDevice, pSrcFile, pDefines, pInclude, pFunctionName, pProfile, 
                                 Flags1, Flags2, pPump, (ID3D11DeviceChild **)ppShader, ppShaderBlob, 
...
HRESULT CreateDomainShaderFromFile( ID3D11Device* pd3dDevice, LPCWSTR pSrcFile, CONST D3D10_SHADER_MACRO* pDefines, 
                                    LPD3D10INCLUDE pInclude, LPCSTR pFunctionName, LPCSTR pProfile, UINT Flags1, UINT Flags2, 
                                    ID3DX11ThreadPump* pPump, ID3D11DomainShader** ppShader, ID3D10Blob** ppShaderBlob, 
                                    BOOL bDumpShader )
{
    return CreateShaderFromFile( pd3dDevice, pSrcFile, pDefines, pInclude, pFunctionName, pProfile, 
                                 Flags1, Flags2, pPump, (ID3D11DeviceChild **)ppShader, ppShaderBlob, 
...
HRESULT CreateGeometryShaderFromFile( ID3D11Device* pd3dDevice, LPCWSTR pSrcFile, CONST D3D10_SHADER_MACRO* pDefines, 
                                      LPD3D10INCLUDE pInclude, LPCSTR pFunctionName, LPCSTR pProfile, UINT Flags1, UINT Flags2, 
                                      ID3DX11ThreadPump* pPump, ID3D11GeometryShader** ppShader, ID3D10Blob** ppShaderBlob, 
                                      BOOL bDumpShader )
{
    return CreateShaderFromFile( pd3dDevice, pSrcFile, pDefines, pInclude, pFunctionName, pProfile, 
                                 Flags1, Flags2, pPump, (ID3D11DeviceChild **)ppShader, ppShaderBlob, 
...
HRESULT CreatePixelShaderFromFile( ID3D11Device* pd3dDevice, LPCWSTR pSrcFile, CONST D3D10_SHADER_MACRO* pDefines, 
                                   LPD3D10INCLUDE pInclude, LPCSTR pFunctionName, LPCSTR pProfile, UINT Flags1, UINT Flags2, 
                                   ID3DX11ThreadPump* pPump, ID3D11PixelShader** ppShader, ID3D10Blob** ppShaderBlob, 
                                   BOOL bDumpShader )
{
    return CreateShaderFromFile( pd3dDevice, pSrcFile, pDefines, pInclude, pFunctionName, pProfile, 
                                 Flags1, Flags2, pPump, (ID3D11DeviceChild **)ppShader, ppShaderBlob, 
