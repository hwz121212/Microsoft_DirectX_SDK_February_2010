                                      ...
                                      void* pUserContext )
{
    ...
    V_RETURN( CompileShaderFromFile( L"MultithreadedRendering11_VS.hlsl", "VSMain", pszVSModel, &pVertexShaderBuffer ) );
    V_RETURN( CompileShaderFromFile( L"MultithreadedRendering11_PS.hlsl", "PSMain", pszPSModel, &pPixelShaderBuffer ) );
