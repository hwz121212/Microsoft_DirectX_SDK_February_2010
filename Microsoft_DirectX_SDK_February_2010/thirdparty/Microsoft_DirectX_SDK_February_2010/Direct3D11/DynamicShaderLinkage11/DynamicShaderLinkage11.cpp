//--------------------------------------------------------------------------------------
// File: DyanmicShaderLinkage11.cpp
//
...
HRESULT CompileShaderFromFile( WCHAR* szFileName, DWORD flags, LPCSTR szEntryPoint, LPCSTR szShaderModel, ID3DBlob** ppBlobOut )
{
    ...
    ID3DBlob* pErrorBlob;
    hr = D3DX11CompileFromFile( szFileName, NULL, pIncludeHandler, szEntryPoint, szShaderModel, 
                                      ...
                                      void* pUserContext )
{
    ...
    if (supportedFeatureLevel >= D3D_FEATURE_LEVEL_11_0)
    {
       ...
       V_RETURN( CompileShaderFromFile( L"DynamicShaderLinkage11_VS.hlsl", D3D10_SHADER_ENABLE_STRICTNESS, 
                                                   "VSMain", "vs_5_0" , &pVertexShaderBuffer ) );
       V_RETURN( CompileShaderFromFile( L"DynamicShaderLinkage11_PS.hlsl", D3D10_SHADER_ENABLE_STRICTNESS, // | D3D10_SHADER_OPTIMIZATION_LEVEL0, 
                                                   "PSMain", "ps_5_0" , &pPixelShaderBuffer ) );
    ...
    else // Lower feature levels than 11 have no support for Dynamic Shader Linkage - need to use a static setting
    {
       switch( supportedFeatureLevel )
       {
           case D3D_FEATURE_LEVEL_10_1:
              {
               V_RETURN( CompileShaderFromFile( L"DynamicShaderLinkage11_VS.hlsl", D3D10_SHADER_ENABLE_BACKWARDS_COMPATIBILITY, 
                                                      "VSMain", "vs_4_1" , &pVertexShaderBuffer ) );
               V_RETURN( CompileShaderFromFile( L"DynamicShaderLinkage11_PS.hlsl",  D3D10_SHADER_ENABLE_BACKWARDS_COMPATIBILITY,
                                                      "PSMain", "ps_4_1" , &pPixelShaderBuffer ) );
               break;
              }
           case D3D_FEATURE_LEVEL_10_0:
              {
               V_RETURN( CompileShaderFromFile( L"DynamicShaderLinkage11_VS.hlsl",  D3D10_SHADER_ENABLE_BACKWARDS_COMPATIBILITY,
                                                      "VSMain", "vs_4_0" , &pVertexShaderBuffer ) );
               V_RETURN( CompileShaderFromFile( L"DynamicShaderLinkage11_PS.hlsl",  D3D10_SHADER_ENABLE_BACKWARDS_COMPATIBILITY,
                                                      "PSMain", "ps_4_0" , &pPixelShaderBuffer ) );
               break;
              }
           case D3D_FEATURE_LEVEL_9_3:
              {
               V_RETURN( CompileShaderFromFile( L"DynamicShaderLinkage11_VS.hlsl",  D3D10_SHADER_ENABLE_BACKWARDS_COMPATIBILITY,
                                                      "VSMain", "vs_4_0_level_9_3" , &pVertexShaderBuffer ) );
               V_RETURN( CompileShaderFromFile( L"DynamicShaderLinkage11_PS.hlsl",  D3D10_SHADER_ENABLE_BACKWARDS_COMPATIBILITY,
                                                       "PSMain", "ps_4_0_level_9_3" , &pPixelShaderBuffer ) );
               break;
              }
           ...
           case D3D_FEATURE_LEVEL_9_1:
              {
               V_RETURN( CompileShaderFromFile( L"DynamicShaderLinkage11_VS.hlsl",  D3D10_SHADER_ENABLE_BACKWARDS_COMPATIBILITY,
                                                      "VSMain", "vs_4_0_level_9_1" , &pVertexShaderBuffer ) );
               V_RETURN( CompileShaderFromFile( L"DynamicShaderLinkage11_PS.hlsl",  D3D10_SHADER_ENABLE_BACKWARDS_COMPATIBILITY,
                                                      "PSMain", "ps_4_0_level_9_1" , &pPixelShaderBuffer ) );
               break;
              }
       }
